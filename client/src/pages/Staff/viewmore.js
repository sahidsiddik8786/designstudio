...
const UserImagesPage = () => {
    ...
    const fetchUserImages = async () => {
      try {
        const response = await axios.get(
          `https://designstudio-1.onrender.com/api/v1/site/user/${userId}/images`
        );
  ...
  useEffect(() => {
    const fetchSuggestedImages = async () => {
      try {
        const response = await axios.get(
          `https://designstudio-1.onrender.com/api/get-suggestion-images/${userId}`
        );
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://designstudio-1.onrender.com/api/upload-suggestion",
        formData,
        {
          headers: {
