...
const CreatesubCategory = () => {
  ...
  const getAllSubcategories = async (categoryId) => {
    try {
      const { data } = await axios.get(`https://designstudio-1.onrender.com/api/v1/category/${categoryId}/subcategories`);
      if (data.success) {
  ...
  const handleAddSubcategory = async () => {
    try {
      ...
      const { data } = await axios.post(`https://designstudio-1.onrender.com/api/v1/category/${selectedCategory}/subcategories`, {
  ...
  const handleUpdateSubcategory = async () => {
    try {
      ...
      const { data } = await axios.put(`https://designstudio-1.onrender.com/api/v1/category/update-subcategory/${selectedSubcategory._id}`, {
  ...
  const handleDisableSubcategory = async (subcategoryId) => {
    try {
      const { data } = await axios.put(`https://designstudio-1.onrender.com/api/v1/category/disable-subcategory/${subcategoryId}`);
      ...
      console.log(error);
      message.error('Something went wrong while disabling subcategory.');
    }
  };
