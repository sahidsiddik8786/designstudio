  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://enigma-designs.onrender.com/api/v1/product/update-product/${id}`,
        productData
      );
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `https://enigma-designs.onrender.com/api/v1/product/delete-product/${id}`
      );
            ...
            <div className="m-1 w-75 ">
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`https://enigma-designs.onrender.com/api/v1/product/product-photo/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
